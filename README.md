...
3. **Inference & Data Tier (Model):** - **Groq Cloud LPU:** Provides ultra-low latency inference using `llama-3.3-70b-versatile`.
...
This project was engineered as part of the B.E. Computer Science and Engineering (AIML) curriculum (Semester 6) at Bharat College of Engineering, affiliated with Mumbai University. It practically implements core syllabus concepts including:
